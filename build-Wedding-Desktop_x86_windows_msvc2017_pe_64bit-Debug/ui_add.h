...
public:
    ...
    void retranslateUi(QDialog *Add)
    {
        ...
        label->setText(QApplication::translate("Add", "Husband's Name", nullptr));
        label_3->setText(QApplication::translate("Add", "Wife's Name", nullptr));
        label_2->setText(QApplication::translate("Add", "Contact Number", nullptr));
        label_4->setText(QApplication::translate("Add", "Place", nullptr));
        label_5->setText(QApplication::translate("Add", "Date", nullptr));
        label_6->setText(QApplication::translate("Add", "Food", nullptr));
        comboBox->setItemText(0, QApplication::translate("Add", "Yes", nullptr));
        comboBox->setItemText(1, QApplication::translate("Add", "No", nullptr));

        label_7->setText(QApplication::translate("Add", "Number of quest", nullptr));
        label_8->setText(QApplication::translate("Add", "Photographer", nullptr));
        comboBox_2->setItemText(0, QApplication::translate("Add", "Yes", nullptr));
        comboBox_2->setItemText(1, QApplication::translate("Add", "No", nullptr));

        label_9->setText(QApplication::translate("Add", "Toastmaster", nullptr));
        comboBox_3->setItemText(0, QApplication::translate("Add", "Yes", nullptr));
        comboBox_3->setItemText(1, QApplication::translate("Add", "No", nullptr));

        label_10->setText(QApplication::translate("Add", "DJ", nullptr));
        comboBox_4->setItemText(0, QApplication::translate("Add", "Yes", nullptr));
        comboBox_4->setItemText(1, QApplication::translate("Add", "No", nullptr));

        label_11->setText(QApplication::translate("Add", "Input information", nullptr));
        pushButton->setText(QApplication::translate("Add", "Supply", nullptr));
        pushButton_2->setText(QApplication::translate("Add", "Cancel", nullptr));
    } // retranslateUi
